...
%	\begin{minipage}[]{0.7\linewidth}
%		\centering
%		\prplot{data/pca/grid_color_text/9_23_s/pr_1.txt}{E=0.1}
%		\prplotadd{data/pca/grid_color_text/9_23_s/pr_3.txt}{E=0.3}
%		\prplotadd{data/pca/grid_color_text/9_23_s/pr_5.txt}{E=0.5}
%		\prplotadd{data/pca/grid_color_text/9_23_s/pr_7.txt}{E=0.7}
%		\prplotadd{data/pca/grid_color_text/9_23_s/pr_9.txt}{E=0.9}
%		\prplotadd{data/pca/grid_color_text/9_23_s/pr_9.9.txt}{E=0.99}
%		\prplotadd{data/pca/grid_color_text/9_23_s/pr_11.txt}{No PCA}
%		\prplotadd{data/concat/9_23_s/pr_1.txt}{No EM}
%		\prplotclose
%		\subcaption{Resultant graph}
%	\end{minipage}
%	\caption{Gridded RGB histogram, and edge orientation histogram, using PCA for query image 9\_23\_s}
%	\label{fig:pca-grid-color-text-sheep}
%\end{figure}
%
%\begin{figure}[ht]
%	\begin{minipage}[]{0.3\linewidth}
...
%	\begin{minipage}[]{0.7\linewidth}
%		\centering
%		\prplot{data/pca/grid_color_text/13_1_s/pr_1.txt}{E=0.1}
%		\prplotadd{data/pca/grid_color_text/13_1_s/pr_3.txt}{E=0.3}
%		\prplotadd{data/pca/grid_color_text/13_1_s/pr_5.txt}{E=0.5}
%		\prplotadd{data/pca/grid_color_text/13_1_s/pr_7.txt}{E=0.7}
%		\prplotadd{data/pca/grid_color_text/13_1_s/pr_9.txt}{E=0.9}
%		\prplotadd{data/pca/grid_color_text/13_1_s/pr_9.9.txt}{E=0.99}
%		\prplotadd{data/pca/grid_color_text/13_1_s/pr_11.txt}{No PCA}
%		\prplotadd{data/concat/13_1_s/pr_1.txt}{No EM}
%		\prplotclose
%		\subcaption{Resultant graph}
%	\end{minipage}
%	\caption{Gridded RGB histogram, and edge orientation histogram, using PCA for query image13\_1\_s}
%	\label{fig:pca-grid-color-text-books}
%\end{figure}
